...
DIJA is open-source software, and you are free to use, modify, and distribute it in accordance with the terms of the MIT License.
...
<footer style="text-align: right; position: fixed; bottom: 0; left: 0; right: 0; background-color: #007BFF; color: white; padding: 1px ;">
    <p style="margin-right: 10px; font-size: 13px; font-style: italic;">&copy; 21020417 Phạm Xuân Trường</p>
</footer>
